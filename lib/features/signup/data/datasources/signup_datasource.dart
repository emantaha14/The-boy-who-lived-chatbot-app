...
abstract class SignupDatasource {
  Future<SignupResponseModel> signup(String username, String password, String fullName, String email);
}

class SignupDataSourceImpl implements SignupDatasource {
  @override
  Future<SignupResponseModel> signup(String username, String password, String fullName, String email) async {
